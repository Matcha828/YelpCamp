...
router.get("/",function (req,res) {
    ...
    Campgrounds.find({},function (err,allCampgrounds) {
        if(err){
            ...
            res.render("campgrounds/index",{campgroundsVar: allCampgrounds, currentUserVar:req.user, page:"campground"})
        }
    });
});
...
router.post("/",middleware.isLoggedIn,function (req,res) {
    ...
    var newCampground = {name:name, image:image,price:price,author:author,description:description};
